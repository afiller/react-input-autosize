	...
	createClass(AutosizeInput, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				this.renderStyles(),
				this.props.inputIsTextArea ? React.createElement('textarea', _extends({}, inputProps, { ref: this.inputRef, wrap: inputProps.wrap ? inputProps.wrap : "off" })) : React.createElement('input', _extends({}, inputProps, { ref: this.inputRef })),
				React.createElement(
					'div',
